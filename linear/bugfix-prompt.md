...
3. If you are unsure, cannot reproduce confidently, or need runtime evidence:
   - invoke skill: `/runtime-debugging`,
   - explain what additional information is needed,
   - guide the developer on what to capture next.

Upon completion:

1. Restate the issue clearly in your own words. Explain the root cause in a concise and developer-friendly way.

2. Explain the fix

- explain exactly what changed,
- request manual validation,
- explain the manual validation steps clearly.
